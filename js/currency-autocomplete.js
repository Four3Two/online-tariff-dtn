$(function(){
  var currencies = [
    ...
    { value: 'Bali', data: 'BSD' },
    { value: 'Balikpapan', data: 'BHD' },
    { value: 'Bulak Kapal', data: 'BDT' },
    { value: 'Ubud, Bali Indonesia', data: 'BBD' },
    { value: 'Bangli, Bali Indonesia', data: 'BYR' },
    { value: 'Singaraja, Bali Indonesiar', data: 'BZD' },
    { value: 'Gianyar, Bali Indonesia', data: 'XOF' },
    { value: 'Klungkung, Bali Indonesia', data: 'BTN' },
    { value: 'Tabanan, Bali Indonesia', data: 'BTN' },
    { value: 'Seminyak, Bali Indonesia', data: 'BTN' },
    { value: 'Denpasar, Bali Indonesia', data: 'BTN' },
    { value: 'Dawan, Bali Indonesia', data: 'BTN' },
    { value: 'Penebel, Bali Indonesia', data: 'BTN' },
    { value: 'Kuta, Bali Indonesia', data: 'BTN' },
    { value: 'Tembuku, Bali Indonesia', data: 'BTN' },
    { value: 'Jembrana, Bali Indonesia', data: 'BTN' },
    { value: 'Selemadeg, Bali Indonesia', data: 'BTN' },
    { value: 'Sawan, Bali Indonesia', data: 'BTN' },
